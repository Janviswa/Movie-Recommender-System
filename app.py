...
API_KEY = "8227d8bd886201445435310338a66f58"
...
# --------------------- Header ---------------------
st.markdown('<div class="main-title">🍿 CineMatch – Your Movie Companion</div>', unsafe_allow_html=True)
...
# --------------------- Footer ---------------------
st.markdown('<div class="footer">🍿 CineMatch & Chill – Your next binge starts here. © 2025</div>', unsafe_allow_html=True)
